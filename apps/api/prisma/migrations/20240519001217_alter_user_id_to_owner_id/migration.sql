/*
  ...
  - Added the required column `owner` to the `organizations` table without a default value. This is not possible if the table is not empty.
...
-- AddForeignKey
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_owner_fkey" FOREIGN KEY ("owner") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
